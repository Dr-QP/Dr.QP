...
model: inherit # Optional: specific model selection
...
Always create `.agent.md` files in the `.claude/agents/` folder of the workspace. Use kebab-case for filenames (e.g., `security-reviewer.agent.md`).
