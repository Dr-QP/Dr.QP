...
fixture files. Refer to the tests under `packages/development/drqp_validate_agents/test/validate_skills/` for concrete examples
...
- [Validation package](../../packages/development/drqp_validate_agents/)
