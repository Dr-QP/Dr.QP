...
This Ansible role installs a comprehensive set of development tools required
for ROS 2 development, including build tools, version control, Python tools,
pre-commit, zizmor, and required libraries.
